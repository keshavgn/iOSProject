...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/iOSFramework/iOS-Framework/SDK/VCRTC.framework"
  install_framework "${PODS_ROOT}/iOSFramework/iOS-Framework/SDK/VCRTCScreenShare.framework"
  install_framework "${PODS_ROOT}/iOSFramework/iOS-Framework/SDK/WebRTC.framework"
