...
final class CustomAlertView: UIView {
    ...
    private func commonInit() {
        ...
        contentView.doneButton.addTarget(self, action: #selector(doneButtonAction), for: UIControl.Event.touchDragInside)
        contentView.cancelButton.addTarget(self, action: #selector(cancelButtonAction), for: UIControl.Event.touchDragInside)
