//
//  MLImageRecognitionViewController.swift
//  iOSProject
//
...
class MLImageRecognitionViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = Localized.ImageRecognition.title
...
extension MLImageRecognitionViewController {
...
extension MLImageRecognitionViewController: UINavigationControllerDelegate, UIImagePickerControllerDelegate {
